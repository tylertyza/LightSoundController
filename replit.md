...
- **Mobile Panel Improvements** (July 18, 2025): Disabled backdrop click dismissal for mobile panels - panels now only close via the close button or switching windows in the bottom menu. Added bottom padding to both Light Studio and Device Lab panels so controls aren't hidden by the mobile menu. This provides a more controlled mobile experience
